                ...
                <div class="row px-0">
                    ...
                    <div class="col-lg-6 px-0 d-flex align-items-center justify-content-center">
                        <a href="javascript:void(0);" class="devx-video-trigger" data-video="{{ asset('videos/hero-section-video.mp4') }}">
                            <img src="{{ asset('images/thumbnails/devxcloud-hero-section-thumbnail.jpeg') }}" alt="CommerceAI Hero Section Video Thumbnail" style="width: 80%; cursor: pointer; border-radius: 12px; margin-left: 30px; margin-bottom: 30px;">
                        </a>
                    </div>
                </div>
            </div>
